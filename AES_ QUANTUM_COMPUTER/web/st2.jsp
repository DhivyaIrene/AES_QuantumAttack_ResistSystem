<%-- 
    Document   : st2
    Created on : Feb 13, 2023, 1:35:16 PM
    Author     : ADMIN
--%>
...
-->
    ...
    <body bgcolor="#003366"><form action="supload" method="post">
                				<%   int a111=0;
  ...
  <tr>
    <td><img  src="images/cloud-computing-banner1.jpg" width="1092" height="275"/></td>
  </tr>
  <tr>
