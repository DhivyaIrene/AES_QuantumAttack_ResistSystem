<%-- 
    Document   : st3
    Created on : Feb 13, 2023, 1:35:31 PM
    Author     : ADMIN
--%>
...
-->
    ...
    <body bgcolor="#003366"> <form action="sdownload" method="post">
	   <%
   String ok="";
      String ok1="";
   String msg="",msg1="";
  ...
  <tr>
    <td><img  src="images/cloud-computing-banner1.jpg" width="1092" height="277"/></td>
  </tr>
  <tr>
 ...
 <tr>
    <td height="450" align="center"><table width="956" border="0">
      <tr>
        <td width="950" height="49" align="center" bgcolor="#006699"><span class="style4"><strong>DEPARTMENT FILE DOWNLOAD </strong></span></td>
      </tr>
      <tr>
    ...
    <td align="center"><table width="240" border="0" align="center">
      ...
      <tr>
        <td align="center"><label>
          <input type="submit" name="t1" value="Download"></label></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
