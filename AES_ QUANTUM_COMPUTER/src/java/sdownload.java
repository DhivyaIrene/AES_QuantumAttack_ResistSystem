    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String mail="";
			...
			if(r1.next())
			{
                       ...
                       RequestDispatcher rs2 = request.getRequestDispatcher("st3.jsp");
			...
			if(r.next())
			{
				...
				while((size=Asset.read(byteArray))!=-1)
				{
					response.getOutputStream().write(byteArray, 0, size);	
                       ...
                       RequestDispatcher rs12 = request.getRequestDispatcher("st3.jsp");
...
//                                }
			...
			if(r.next())
			{
                ...
                rs12.forward(request, response);
                       ...
                       RequestDispatcher rs112 = request.getRequestDispatcher("st3.jsp");
...
if(v==1){
     ...
     request.setAttribute("ok2", "1");
        ...
        RequestDispatcher rs2 = request.getRequestDispatcher("st3.jsp");
                ...
                RequestDispatcher rs21 = request.getRequestDispatcher("st3.jsp");
