<%-- 
    Document   : h2
    Created on : Feb 13, 2023, 1:34:30 PM
    Author     : ADMIN
--%>
...
-->
    ...
    <body bgcolor="#003366"><form action="v1" method="post">
	   <%
   String ok="";
  ...
  <tr>
    <td><img  src="images/cloud-computing-banner1.jpg" width="1092" height="263"/></td>
  </tr>
  <tr>
      ...
      <tr>
        <td width="925"><table width="936" height="33" border="0">
          <tr>
            ...
            <td width="121"><div align="center"><strong>USER ID </strong></div></td>
            <td width="162"><div align="center"><strong>NAME </strong></div></td>
            <td width="180"><div align="center"><strong>COMPANY NAME  </strong></div></td>
             <td width="177"><div align="center"><strong>MOBILE</strong></div></td>
			   <td width="158"><div align="center"><strong>EMAIL ID </strong></div></td>
            </tr>
        </table></td>
      </tr>
      <tr>
 ...
 System.out.println(a11);
		...
		ResultSet rs = st.executeQuery("select * from register where ack=''and department='"+asc.toEncrypt(so.getAttribute("un3").toString().getBytes())+"' ");
    ...
    while(rs.next())
	 ...
	 %><tr>
            ...
            <td width="115"><div align="center">
                    <input name="b" type="radio" value="<%=dsc.toDeycrypt(rs.getString(1))%>">
            </div></td>
            <td width="122"><div align="center"><%=dsc.toDeycrypt(rs.getString(1))%></div></td>
            <td width="159"><div align="center"><%=dsc.toDeycrypt(rs.getString(2))%></div></td>
            <td width="180"><div align="center"><%=dsc.toDeycrypt(rs.getString(8))%></div></td>
              <td width="179"><div align="center"><%=dsc.toDeycrypt(rs.getString(4))%></div></td>
			       <td width="159"><div align="center"><%=dsc.toDeycrypt(rs.getString(5))%></div></td>
            </tr>  <%
    ...
    <td align="center"><table width="683" border="0" align="center">
      ...
      <tr align="center">
        <td><label>
          ...
          <input type="submit" name="t2" value="Denied">&nbsp;&nbsp;&nbsp;&nbsp;</label></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
