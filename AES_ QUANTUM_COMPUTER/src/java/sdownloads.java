 ...
 * @author ADMIN
 */
public class sdownloads extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String mail="";
			...
			if(r1.next())
			{
                       ...
                       RequestDispatcher rs2 = request.getRequestDispatcher("st4.jsp");
			...
			if(r.next())
			{
				...
				while((size=Asset.read(byteArray))!=-1)
				{
					response.getOutputStream().write(byteArray, 0, size);	
                       ...
                       RequestDispatcher rs12 = request.getRequestDispatcher("st4.jsp");
...
//                                }
			...
			if(r.next())
			{
                ...
                rs12.forward(request, response);
                       ...
                       RequestDispatcher rs112 = request.getRequestDispatcher("st4.jsp");
                ...
                if (rs != null) {
                    if (rs.next()) {
                        a1=rs.getString(2);
                                 a2=rs.getString(4);
                                   as=dsc.toDeycrypt(rs.getString(11));  verify=rs.getString(8); 
                    }
                }
			...
			if(r1.next())
			{
               ...
               int v=st.executeUpdate("insert into verify values('"+s2+"','"+b+"','"+a1+"','"+a2+"','"+so.getAttribute("un")+"','','"+phone+"','"+mail+"','"+f+"','','"+as+"','"+verify+"')");
...
if(v==1){
     ...
     request.setAttribute("ok2", "1");
        ...
        RequestDispatcher rs2 = request.getRequestDispatcher("st4.jsp");
                ...
                RequestDispatcher rs21 = request.getRequestDispatcher("st4.jsp");
