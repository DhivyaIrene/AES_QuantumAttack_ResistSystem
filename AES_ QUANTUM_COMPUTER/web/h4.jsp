<%-- 
    Document   : h4
    Created on : Feb 13, 2023, 5:24:52 PM
    Author     : ADMIN
--%>
...
-->
    ...
    <body bgcolor="#003366"> <form action="download" method="post">
	   <%
   String ok="";
      String ok1="";
   String msg="",msg1="";
  ...
  <tr>
    <td><img  src="images/cloud-computing-banner1.jpg" width="1092" height="278"/></td>
  </tr>
  <tr>
