...
public class v1 extends HttpServlet {
   ...
   ResultSet rs=st.executeQuery("select * from register where userid='"+asc.toEncrypt(b.getBytes())+"'");
       if(rs!=null){
            ...
            if (request.getParameter("t1") != null) {
                ...
                System.out.println("Formatted date is ==>" + f);
                 ...
                 int v1=st.executeUpdate("update register set ack ='Accept' where userid='"+asc.toEncrypt(b.getBytes())+"'");
                 if(v1==1){
                       
                         request.setAttribute("ok", "1");
                          request.setAttribute("msg", "Accepted Succesfully");
                              
                       RequestDispatcher rs2 = request.getRequestDispatcher("h2.jsp");
                ...
                System.out.println("Formatted date is ==>" + f);
                 ...
                 int v1=st.executeUpdate("update register set ack='Denied' where userid='"+asc.toEncrypt(b.getBytes())+"'");
                 if(v1==1){
